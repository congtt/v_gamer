...
//	public static Html AddForm(String typeInput, String name, String value, String title, String className, String style, List<HashMap<String, String>> options) {
//
//		Html content = views.html.forms.forms.render(type, typeInput, name, value, title, className, style, options);
//		return content;
//	}
//
//	public static Html addInput(String typeInput, String name, String value, String title, String className, String style) {
//		type = 1;
//		return AddForm(typeInput, name, value, title, className, style, null);
//	}
//
//	public static Html addSelectList(String name, String value, String title, String className, String style, List<HashMap<String, String>> options) {
//		type = 2;
//		return AddForm("", name, value, title, className, style, options);
//	}
//
//	public static Html addRadio(String name, String value, String title, String className, String style, List<HashMap<String, String>> options) {
//		type = 3;
//		return AddForm("", name, value, title, className, style, options);
//	}
...
//	
	...
	public static Html addTextarea(String name, int rows, int col,String value, HashMap<String, String> attrList) {
		...
		String attr = addAttribute(attrList);
		String inp = "<textarea rows=\"" + String.valueOf(rows) + "\" rows=\"" + String.valueOf(col) + "\"  name=\"" + name + "\" value=\"" + value + "\" " + attr + " />";

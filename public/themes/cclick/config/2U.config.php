...
/***********1**********************/
$promotion_id = 14;
$ccp_config[$promotion_id]['server_ip']=120;
$ccp_config[$promotion_id]['title']='Nhận code 2U';
$ccp_config[$promotion_id]['playingtime']=0;
$ccp_config[$promotion_id]['from_date']='2014/01/22 14:00:00';
$ccp_config[$promotion_id]['to_date']='2014/02/05 23:59:59';
...
//$ccp_config[14]['debug']=array('tranngoclinh2812'=>1); 

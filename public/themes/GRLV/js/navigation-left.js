jQuery.fn.extend({
    addNavigationLeft: function () {
        ...
        $navigation = function (jEl) {
            ...
            /*MAIN*/
            this.navigation = jEl;
            this.navigation.find("li:not(.showChild)").each(function () {
                var o = $(this);
                    ...
                    if (self.options.event == "click") { //open self
                        if ( !o.hasClass("Active") ) {
                            if ( self.options.effect ) {
                                var timer = setInterval(function () {
                                    if ( onFire ) {
                                        ...
                                        if ( o.find("> ul:first").length > 0 ) {
                                            o.find("> ul:first").slideDown("fast", function () {
                                                onFire = false;
                                            });
                                        }
                                        else {
                                ...
                                o.addClass("Active");
                                o.find("> ul:first").show('drop',{},'fast');
                            }
                        }
                        else { //close self
                            if ( self.options.effect ) { //close the parent most Active
                                if ( o.find("> ul:first").length > 0 ) {
                                    o.find("> ul:first").slideUp("fast", function () {
